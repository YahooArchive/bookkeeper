...
class ResponseBuilder {
    static BookieProtocol.Response buildErrorResponse(int errorCode, BookieProtocol.Request r) {
        ...
        } else if (r.getOpCode() == BookieProtocol.TRIM) {
            return new BookieProtocol.TrimResponse(r.getProtocolVersion(), errorCode, r.getLedgerId(), r.getEntryId());
        } else {
    ...
    static BookieProtocol.Response buildTrimResponse(BookieProtocol.Request r) {
        return new BookieProtocol.TrimResponse(r.getProtocolVersion(), BookieProtocol.EOK, r.getLedgerId(),
                                              r.getEntryId());
    }
