...
public interface BookieProtocol {
    ...
    static class TrimRequest extends Request {
        TrimRequest(byte protocolVersion, long ledgerId, long entryId,
                   short flags, byte[] masterKey) {
            super(protocolVersion, TRIM, ledgerId, entryId, flags, masterKey);
        }
    }
    ...
    static class TrimResponse extends Response {
        TrimResponse(byte protocolVersion, int errorCode, long ledgerId, long entryId) {
            super(protocolVersion, TRIM, errorCode, ledgerId, entryId);
        }
    }
}
