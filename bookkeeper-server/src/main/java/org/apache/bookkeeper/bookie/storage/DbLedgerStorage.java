...
public class DbLedgerStorage implements LedgerStorage {
    ...
    public boolean ledgerExists(long ledgerId) throws IOException {
        ...
        log.debug("Ledger exists. ledger: {} : {}", ledgerId, ledgerData.exists());
        return ledgerData.exists();
    }
    ...
    public boolean isFenced(long ledgerId) throws IOException {
        ...
        return ledgerIndex.get(ledgerId).isFenced();
    }
    ...
    public void setMasterKey(long ledgerId, byte[] masterKey) throws IOException {
        ...
        LedgerData ledgerData = ledgerIndex.get(ledgerId);
        ledgerData.setMasterKey(masterKey);
        ledgerIndex.set(ledgerId, ledgerData);
    }
    ...
    public void deleteAllLedgers() throws IOException {
        ...
        entryLocationIndex.deleteAll();
        ledgerIndex.deleteAll();
    }
